...
public class SimpleNotificationDialog extends PopupDialog {

    public SimpleNotificationDialog(Context context, String tag, CharSequence content) {
        super(context, tag, R.layout.dialog_simple_popup, true, true);
        init(content);
    }
    
    public SimpleNotificationDialog(Context context, String tag, int contentRes) {
        this(context, tag, MatjiConstants.string(contentRes));        
    }
    
    public SimpleNotificationDialog(Context context, String tag, String content) {
