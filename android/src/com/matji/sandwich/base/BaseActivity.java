...
public abstract class BaseActivity extends Activity implements ActivityEnterForeGroundListener, Identifiable {
    ...
    public static final int LOGIN_ACTIVITY = 99;
    public static final int POST_MAIN_ACTIVITY = 100;
    public static final int POST_EDIT_ACTIVITY = 101;
    public static final int WRITE_POST_ACTIVITY = 120;
    public static final int WRITE_COMMENT_ACTIVITY = 121;
    public static final int STORE_MAIN_ACTIVITY = 115;
    public static final int STORE_DETAIL_INFO_TAB_ACTIVITY = 116;
    public static final int IMAGE_SLIDER_ACTIVITY = 150;
    public static final int USER_MAIN_ACTIVITY = 131;
    public static final int USER_PROFILE_TAB_ACTIVITY = 132;
    public static final int USER_PROFILE_ACTIVITY = 133;
    public static final int RECEIVED_USER_ACTIVITY = 134;
