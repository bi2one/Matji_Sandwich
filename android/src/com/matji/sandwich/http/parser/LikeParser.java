...
public class LikeParser extends MatjiDataParser<Like> {
	protected Like getMatjiData(JsonObject object) throws MatjiException {
		...
		like.setUser(new UserParser().getRawObject(getObject(object, "user") + ""));
		like.setStore(new StoreParser().getRawObject(getObject(object, "store") + ""));
