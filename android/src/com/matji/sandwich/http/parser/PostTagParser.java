...
public class PostTagParser extends MatjiDataParser<PostTag> {
	protected PostTag getMatjiData(JsonObject object) throws MatjiException {
		...
		postTag.setTag(new TagParser().getRawObject(getObject(object, "tag") + ""));
		postTag.setPost(new PostParser().getRawObject(getObject(object, "post") + ""));
