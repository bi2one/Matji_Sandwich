...
public class MessageParser extends MatjiDataParser<Message> {
	protected Message getMatjiData(JsonObject object) throws MatjiException {
		...
		message.setSentUser(new UserParser().getRawObject(getObject(object, "sent_user") + ""));
		message.setReceivedUser(new UserParser().getRawObject(getObject(object, "received_user") + ""));
