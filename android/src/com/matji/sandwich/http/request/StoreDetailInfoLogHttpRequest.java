...
import com.matji.sandwich.http.parser.StoreDetailInfoLogParser;
...
public class StoreDetailInfoLogHttpRequest extends HttpRequest {
    private Hashtable<String, String> hashtable;
    
    public StoreDetailInfoLogHttpRequest() {
	parser = new StoreDetailInfoLogParser();
