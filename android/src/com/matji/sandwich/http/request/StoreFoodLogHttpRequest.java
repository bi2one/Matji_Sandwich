...
import com.matji.sandwich.http.parser.StoreFoodLogParser;
...
public class StoreFoodLogHttpRequest extends HttpRequest {
    private Hashtable<String, String> hashtable;
    private int page;
    private int id;
    private MatjiDataParser parser;

    public StoreFoodLogHttpRequest() {
	parser = new StoreFoodLogParser();
